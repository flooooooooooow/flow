...
Run from project root: python wasm/flow_to_wasm.py examples/fibonacci.flow
"""
...
class FlowToWasmConverter:
    ...
    def convert_file(self, flow_file_path, output_dir=None):
        ...
        # Default output to wasm/wasm_examples
...
def main():
    if len(sys.argv) < 2:
        print("Usage:")
        print("  python wasm/flow_to_wasm.py <flow_file>     # Convert single file")
        print("  python wasm/flow_to_wasm.py --all           # Convert all examples")
        print("")
        print("Example:")
        print("  python wasm/flow_to_wasm.py examples/fibonacci.flow")
        sys.exit(1)
