    ...
    nav = {
        ...
        "sections": [
            ...
            },
            {
                ...
                "title": "Core language",
                "items": [
                    {"label": "Introduction to Flow", "path": "book/README.md"},
                    {"label": "Book 1 · A Complete Program", "path": "book/01-a-complete-program.md"},
                    {"label": "Book 2 · Values and Types", "path": "book/02-values-and-types.md"},
                    {"label": "Book 3 · Decisions and Repetition", "path": "book/03-decisions-and-repetition.md"},
                    {"label": "Book 4 · Functions", "path": "book/04-functions.md"},
                    {"label": "Book 5 · Records and Arrays", "path": "book/05-records-and-arrays.md"},
                    {"label": "Book 6 · Pipelines and Results", "path": "book/06-pipelines-and-results.md"},
                    {"label": "Book 7 · Updates to Flows", "path": "book/07-from-updates-to-flows.md"},
                    {"label": "Book 8 · Types and Declarations", "path": "book/08-types-and-declarations.md"},
                    {"label": "Book 9 · Expressions and Matching", "path": "book/09-expressions-and-matching.md"},
                    {"label": "Book 10 · Memory and Lifetimes", "path": "book/10-memory-and-lifetimes.md"},
                    {"label": "Book 11 · Modules and Packages", "path": "book/11-modules-packages-and-interop.md"},
                    {"label": "Book 12 · Effects and Concurrency", "path": "book/12-effects-and-concurrency.md"},
                    {"label": "Book 13 · Evolution and Dynamics", "path": "book/13-evolution-and-dynamics.md"},
                    {"label": "Book 14 · Numerics, Autodiff, and ML", "path": "book/14-numerics-autodiff-and-ml.md"},
                    {"label": "Book 15 · Media, GPU, and Audio", "path": "book/15-media-gpu-and-audio.md"},
                    {"label": "Book 16 · Targets and Distribution", "path": "book/16-targets-and-distribution.md"},
                    {"label": "Book 17 · Engineering and Verification", "path": "book/17-engineering-and-verification.md"},
                    {"label": "Book 18 · Complete Instrument", "path": "book/18-a-complete-instrument.md"},
                    {"label": "Book 19 · Coding Challenges", "path": "book/19-coding-challenge-series.md"},
                    {"label": "Book · Language Card", "path": "book/appendix-a-language-card.md"},
                    {"label": "Book · Feature Coverage", "path": "book/appendix-b-feature-coverage.md"},
                    {"label": "Book · Command Reference", "path": "book/appendix-c-command-reference.md"},
                    {"label": "Book · Standard Library", "path": "book/appendix-d-standard-library-map.md"},
