...
This is the "FLOW side" companion to `scripts/tools/grad/flow_grad_c.py`.
...
Usage:
  PYTHONPATH=src python3 scripts/tools/grad/flow_grad_flow.py <file.flow> <function_name> > out.flow
"""
