...
def main():
    ...
    print("   1. Install Emscripten: git clone https://github.com/emscripten-core/emsdk.git third_party/emsdk")
    print("   2. Activate: cd third_party/emsdk && ./emsdk install latest && ./emsdk activate latest")
