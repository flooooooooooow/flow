...
python scripts/wasm/flow_to_wasm.py examples/fibonacci.flow

# Convert all examples
python scripts/wasm/flow_to_wasm.py --all

# Open in browser
open scripts/scripts/wasm/wasm_examples/index.html
```
...
### Single File
```bash
python scripts/wasm/flow_to_wasm.py examples/effects_working.flow
```

### Custom Output Directory
```bash
python scripts/wasm/flow_to_wasm.py examples/fibonacci.flow ./my_output
```
...
```bash
cd scripts/scripts/wasm/wasm_examples
...
Run from project root: `python scripts/wasm/flow_to_wasm.py ...`
