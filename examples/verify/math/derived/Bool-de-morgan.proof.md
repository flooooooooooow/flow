...
> **Goal.** ¬(a ∧ b) = (¬a) ∨ (¬b)
>
> $$\forall a \in \{\mathsf{true}, \mathsf{false}\} \forall b \in \{\mathsf{true}, \mathsf{false}\}\quad !(a \land b) = (!a) \lor (!b)$$
...
| ⑦ | From step 6, this implies !(the conjunction of a and b) equals (!a) or (!b) in this case. | ⑦ | $!(a \land b) = (!a) \lor (!b)$ |
| ⑧ | Case 4 (see step 2): suppose b holds. |  |  |
| ⑨ | From step 8, this implies !(the conjunction of a and b) equals (!a) or (!b) in this case. | ⑨ | $!(a \land b) = (!a) \lor (!b)$ |
| ⑩ | Case 5 (see step 2): neither disjunct holds. |  |  |
| ⑪ | From step 10, this implies !(the conjunction of a and b) equals (!a) or (!b). Together with the other cases (step 3, step 4, step 6, step 8, and step 10), the goal is discharged. Hence proven. | ⑪ | $!(a \land b) = (!a) \lor (!b)$ |
...
`boolean truth values · negation · de Morgan for conjunction and disjunction`
