...
**Coordinate.** Comb · choose · choosing six from a successor derived · **Derived fact**
...
| | **Proof** | | **Math** |
|:---:|:---|:---:|:---|
| ① | We prove that choosing six from a successor derived for choose on Comb. |  |  |
...
`Comb · choose · choosing six from a successor derived`
