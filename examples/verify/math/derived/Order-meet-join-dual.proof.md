...
*Meet below join in the dual order witness.*

**Source.** davey-priestley — *Introduction to Lattices and Order*

## Derived fact 1 — meet(a, b) <= join(b, a)

**Coordinate.** Order · lattice · meet below join in dual order · **Derived fact**

*Source: davey-priestley*

*Built on: meet is below join, for lattice on Order, join commutes, for join on Order*
...
| | **Proof** | | **Math** |
|:---:|:---|:---:|:---|
| ① | We prove that meet below join in dual order for lattice on Order. |  |  |
...
`Order · lattice · meet below join in dual order`
