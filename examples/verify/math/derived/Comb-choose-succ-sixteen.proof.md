...
**Coordinate.** Comb · choose · choosing sixteen from a successor · **Derived fact**
...
| | **Proof** | | **Math** |
|:---:|:---|:---:|:---|
| ① | We prove that choosing sixteen from a successor for choose on Comb. |  |  |
...
`Comb · choose · choosing sixteen from a successor`
