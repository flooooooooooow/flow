...
**Coordinate.** Comb · choose · choosing eleven from a successor · **Derived fact**
...
| | **Proof** | | **Math** |
|:---:|:---|:---:|:---|
| ① | We prove that choosing eleven from a successor for choose on Comb. |  |  |
...
`Comb · choose · choosing eleven from a successor`
