...
**Coordinate.** Comb · choose · choosing nineteen from a successor derived · **Derived fact**

*Source: graham-knuth-patashnik*

*Built on: pascal recurrence holds, for choose on Comb, choosing eighteen from a successor derived, for choose on Comb*
...
| | **Proof** | | **Math** |
|:---:|:---|:---:|:---|
| ① | We prove that choosing nineteen from a successor derived for choose on Comb. |  |  |
...
| ③ | We invoke the derived fact governing choose on Comb: choosing eighteen from a successor derived, for choose on Comb (instantiated for n). |  |  |
...
`Comb · choose · choosing nineteen from a successor derived`
