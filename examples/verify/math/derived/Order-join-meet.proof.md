...
*Built on: meet absorbs join, for meet on Order, repeating does not change the value, for join on Order*
...
| | **Proof** | | **Math** |
|:---:|:---|:---:|:---|
| ① | We prove that meet is below join for lattice on Order. |  |  |
...
`Order · lattice · meet is below join`
