...
**Coordinate.** Comb · choose · choosing twenty from a successor · **Derived fact**

*Source: graham-knuth-patashnik*

*Built on: pascal recurrence holds, for choose on Comb, choosing nineteen from a successor, for choose on Comb*
...
| | **Proof** | | **Math** |
|:---:|:---|:---:|:---|
| ① | We prove that choosing twenty from a successor for choose on Comb. |  |  |
...
| ③ | We invoke the derived fact governing choose on Comb: choosing nineteen from a successor, for choose on Comb (instantiated for n). |  |  |
...
`Comb · choose · choosing twenty from a successor`
