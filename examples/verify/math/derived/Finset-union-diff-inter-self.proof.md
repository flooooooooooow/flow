...
*Built on: union diff inter self derived, for difference on Finset, union diff inter empty card bound, for cardinality on Finset*
...
| | **Proof** | | **Math** |
|:---:|:---|:---:|:---|
| ① | We prove that union diff intersect self derived for difference on Finset. |  |  |
| ② | We invoke the derived fact governing difference on Finset: union diff inter self derived, for difference on Finset (instantiated for s, t). |  |  |
...
`Finset · difference · union diff intersect self derived`
