...
*Built on: order does not matter, for meet on Order, order does not matter, for join on Order, repeating does not change the value, for meet on Order*
...
| | **Proof** | | **Math** |
|:---:|:---|:---:|:---|
| ① | We prove that meet absorbs join for meet on Order. |  |  |
...
| ⑤ | From step 2, step 3, and step 4, this implies meet(a, join(a, b)) equals a. Hence proven. | ⑤ | $meet(a, join(a, b)) = a$ |
