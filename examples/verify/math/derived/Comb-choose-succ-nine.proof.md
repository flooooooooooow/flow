...
**Coordinate.** Comb · choose · choosing nine from a successor · **Derived fact**
...
| | **Proof** | | **Math** |
|:---:|:---|:---:|:---|
| ① | We prove that choosing nine from a successor for choose on Comb. |  |  |
...
`Comb · choose · choosing nine from a successor`
