...
*Built on: order does not matter, for intersection on Finset, less-or-equal is reflexive, for order on the natural numbers*
...
| | **Proof** | | **Math** |
|:---:|:---|:---:|:---|
| ① | We prove that intersection size is at most each factor for cardinality on Finset. |  |  |
...
`Finset · cardinality · intersection size is at most each factor`
