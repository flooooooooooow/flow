...
**Coordinate.** Comb · choose · choosing ten from a successor · **Derived fact**
...
| | **Proof** | | **Math** |
|:---:|:---|:---:|:---|
| ① | We prove that choosing ten from a successor for choose on Comb. |  |  |
...
`Comb · choose · choosing ten from a successor`
