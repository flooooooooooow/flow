...
**Coordinate.** Ideal · addition · zero plus zero stays in the ideal · **Derived fact**
...
| | **Proof** | | **Math** |
|:---:|:---|:---:|:---|
| ① | We prove that zero plus zero stays in the ideal for addition on Ideal. |  |  |
...
`Ideal · addition · zero plus zero stays in the ideal`
