...
*Join above meet via left transitivity witness.*

**Source.** davey-priestley — *Introduction to Lattices and Order*

## Derived fact 1 — join(a, b) >= meet(a, b)

**Coordinate.** Order · lattice · join above meet via left transitivity · **Derived fact**
...
| | **Proof** | | **Math** |
|:---:|:---|:---:|:---|
| ① | We prove that join above meet via left transitivity for lattice on Order. |  |  |
...
| ③ | We invoke the derived fact governing leq on Order: transitivity holds, for leq on Order (instantiated for meet(a, b), meet(b, a), join(a, b)). |  |  |
...
`Order · lattice · join above meet via left transitivity`
