...
*Built on: meet below join reflexive, for lattice on Order, meet below join via transitivity, for lattice on Order*
...
| | **Proof** | | **Math** |
|:---:|:---|:---:|:---|
| ① | We prove that meet below join antisymmetric witness for lattice on Order. |  |  |
| ② | We invoke the derived fact governing lattice on Order: meet below join reflexive, for lattice on Order (instantiated for a). |  |  |
| ③ | We invoke the derived fact governing lattice on Order: meet below join via transitivity, for lattice on Order (instantiated for a, b, c). |  |  |
...
`Order · lattice · meet below join antisymmetric witness`
