...
*Self-intersection does not increase cardinality.*

**Source.** graham-knuth-patashnik — *Concrete Mathematics*

## Derived fact 1 — card(s ∩ s) <= card(s)

**Coordinate.** Finset · cardinality · self intersection size is bounded · **Derived fact**
...
| | **Proof** | | **Math** |
|:---:|:---|:---:|:---|
| ① | We prove that self intersection size is bounded for cardinality on Finset. |  |  |
...
`Finset · cardinality · self intersection size is bounded`
