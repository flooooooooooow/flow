...
*Built on: empty on the left gives the set, for union on Finset, less-or-equal is reflexive, for order on the natural numbers*
...
| | **Proof** | | **Math** |
|:---:|:---|:---:|:---|
| ① | We prove that empty left union size is bounded for cardinality on Finset. |  |  |
...
`Finset · cardinality · empty left union size is bounded`
