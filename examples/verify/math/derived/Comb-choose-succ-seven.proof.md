...
**Coordinate.** Comb · choose · choosing seven from a successor · **Derived fact**
...
| | **Proof** | | **Math** |
|:---:|:---|:---:|:---|
| ① | We prove that choosing seven from a successor for choose on Comb. |  |  |
...
`Comb · choose · choosing seven from a successor`
