...
**Coordinate.** Comb · choose · choosing seventeen from a successor derived · **Derived fact**
...
| | **Proof** | | **Math** |
|:---:|:---|:---:|:---|
| ① | We prove that choosing seventeen from a successor derived for choose on Comb. |  |  |
...
`Comb · choose · choosing seventeen from a successor derived`
