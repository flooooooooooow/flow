...
> Auto-generated from `lib/stdlib/` on 2026-08-20 by `scripts/gen_stdlib_docs.py`. Per-function docs come from `#` comments immediately above each `export function`.
