...
Today the language has a compiler and a specification (v0.3.4), but the spec is
...
built on Linux and macOS. Toolchain version is 0.9. spec version is 0.3.4.
...
| Item | Status | Note |
| --- | --- | --- |
| Versioned releases | DONE | `v0.9.0` tags, GitHub Releases. |
