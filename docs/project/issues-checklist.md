...
- [x] #93 [CI-M4] CI: no SAST, DAST, or dependency scanning (enhancement, ci, medium) https://github.com/flooooooooooow/flow/issues/93
...
- [x] #82 [RT-L2] Runtime: all Vulkan state is global/static (enhancement, low, runtime) https://github.com/flooooooooooow/flow/issues/82
...
- [x] #78 **Severity:** Medium | **Category:** Native Runtime" (Short-term) https://github.com/flooooooooooow/flow/issues/78
- [x] #77 ## Audit ID: RT-M1 () https://github.com/flooooooooooow/flow/issues/77
...
- [x] #60 [SL-C2] Stdlib: concurrency primitives provide no actual synchronization (bug, critical, security, stdlib) https://github.com/flooooooooooow/flow/issues/60
...
- [x] #50 [MN-M1] Monomorphize: generic function instantiation is unimplemented (enhancement, compiler, medium) https://github.com/flooooooooooow/flow/issues/50
- [x] #49 [MN-C1] Monomorphize: no termination guard against infinite instantiation (bug, critical, compiler) https://github.com/flooooooooooow/flow/issues/49
...
- [x] #41 [TP-C1] Transpiler: unreachable code / control flow bug (bug, critical, compiler) https://github.com/flooooooooooow/flow/issues/41
...
- [x] #34 [MG-M1] MLIR generator: struct alignment completely ignored (bug, compiler, medium) https://github.com/flooooooooooow/flow/issues/34
...
- [x] #27 [CG-M5] C generator: lambda with block bodies produces broken code (bug, compiler, medium) https://github.com/flooooooooooow/flow/issues/27
...
- [x] #110 [roadmap:async-primitives] Async primitives https://github.com/flooooooooooow/flow/issues/110
  (Phase 1+: ThreadedAsync + flow_concurrency.c + TLS handlers + real channels; fibers/continuations still deferred — docs/language/concurrency-vs-go.md)
- [x] #111 [roadmap:windows-graphics-support] Windows graphics support https://github.com/flooooooooooow/flow/issues/111
- [x] #112 [roadmap:implement-closure-environment-capture-automatic-captures-not-just-explicit-self] Implement closure environment capture (automatic captures, not just explicit self) https://github.com/flooooooooooow/flow/issues/112
- [x] #113 [roadmap:loop-vectorization] Loop vectorization https://github.com/flooooooooooow/flow/issues/113
- [x] #114 [roadmap:real-world-projects] Real-world projects https://github.com/flooooooooooow/flow/issues/114
...
- [x] #116 [roadmap:rt-safety-policy-no-alloc-audio-thread] RT-safety policy (no-alloc audio thread) https://github.com/flooooooooooow/flow/issues/116
...
- [x] #118 [roadmap:gpu-autodiff] GPU autodiff https://github.com/flooooooooooow/flow/issues/118
...
- [x] #120 [roadmap:dead-code-elimination] Dead code elimination https://github.com/flooooooooooow/flow/issues/120
- [x] #121 [roadmap:wasm-target] WASM target https://github.com/flooooooooooow/flow/issues/121
- [x] #122 [roadmap:record-tetris-demo-gif] Record Tetris demo GIF https://github.com/flooooooooooow/flow/issues/122
- [x] #123 [roadmap:function-inlining] Function inlining https://github.com/flooooooooooow/flow/issues/123
...
- [x] #126 [roadmap:constant-propagation] Constant propagation https://github.com/flooooooooooow/flow/issues/126
- [x] #127 [roadmap:debugger] Debugger https://github.com/flooooooooooow/flow/issues/127
- [x] #128 [roadmap:self-hosting-components] Self-hosting components https://github.com/flooooooooooow/flow/issues/128
