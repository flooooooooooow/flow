...
| **Documentation pages** | 138 | 30,490 |
...
*Generated by CI from tracked files at `c72a01a5fec7`. Proof documents: 1,080. [Raw JSON](docs/generated/repository-stats.json) · [Flow counter](scripts/tools/repo_stats/main.flow) · [Python fallback](scripts/update_repo_stats.py).*
<!-- repo-stats:end -->
