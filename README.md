...
|---|---:|---:|
| **Tracked source** | 3,364 | 476,269 |
| **Flow language** | 2,225 | 240,358 |
| **Python compiler (`src/flow`)** | 85 | 57,598 |
...
| **Tests (`.py` + `.flow`)** | 567 | 59,029 |
| **Application programs** | 8 | 1,537 |
| **Registry packages** | 19 | — |
| **Documentation pages** | 198 | 41,008 |
...
*Generated by CI from tracked files at `3dbbac87134e`. Proof documents: 1,080. [Raw JSON](docs/generated/repository-stats.json) · [Flow counter](scripts/tools/repo_stats/main.flow) · [Python fallback](scripts/update_repo_stats.py).*
<!-- repo-stats:end -->
