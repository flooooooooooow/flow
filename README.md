...
|---|---:|---:|
| **Tracked source** | 2,992 | 420,396 |
| **Flow language** | 2,077 | 219,048 |
| **Python compiler (`src/flow`)** | 70 | 50,642 |
| **Self-hosted compiler (`compiler/src`)** | 40 | 22,752 |
| **Standard library modules** | 111 | 33,319 |
| **Native runtime** | 41 | 7,429 |
| **Examples (excluding verify corpus)** | 425 | 105,480 |
| **Verify corpus** | 1,078 | 18,715 |
| **Tests (`.py` + `.flow`)** | 431 | 46,616 |
| **Application programs** | 8 | 1,537 |
| **Registry packages** | 19 | — |
| **Documentation pages** | 171 | 38,321 |
...
*Generated by CI from tracked files at `0edc47870e77`. Proof documents: 1,080. [Raw JSON](docs/generated/repository-stats.json) · [Flow counter](scripts/tools/repo_stats/main.flow) · [Python fallback](scripts/update_repo_stats.py).*
<!-- repo-stats:end -->
