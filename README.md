...
|---|---:|---:|
| **Tracked source** | 3,113 | 442,507 |
| **Flow language** | 2,087 | 226,353 |
| **Python compiler (`src/flow`)** | 72 | 51,274 |
...
| **Tests (`.py` + `.flow`)** | 452 | 48,419 |
| **Application programs** | 8 | 1,537 |
| **Registry packages** | 19 | — |
| **Documentation pages** | 172 | 39,348 |
...
*Generated by CI from tracked files at `e5fb4841d5f5`. Proof documents: 1,080. [Raw JSON](docs/generated/repository-stats.json) · [Flow counter](scripts/tools/repo_stats/main.flow) · [Python fallback](scripts/update_repo_stats.py).*
<!-- repo-stats:end -->
