...
|---|---:|---:|
| **Tracked source** | 3,189 | 452,558 |
| **Flow language** | 2,128 | 229,777 |
| **Python compiler (`src/flow`)** | 74 | 53,124 |
| **Self-hosted compiler (`compiler/src`)** | 49 | 24,400 |
| **Standard library modules** | 111 | 33,237 |
| **Native runtime** | 44 | 8,035 |
| **Examples (excluding verify corpus)** | 428 | 112,776 |
| **Verify corpus** | 1,078 | 18,715 |
| **Tests (`.py` + `.flow`)** | 511 | 53,384 |
| **Application programs** | 8 | 1,537 |
| **Registry packages** | 19 | — |
| **Documentation pages** | 176 | 37,871 |
...
*Generated by CI from tracked files at `ad66dda5bf5c`. Proof documents: 1,080. [Raw JSON](docs/generated/repository-stats.json) · [Flow counter](scripts/tools/repo_stats/main.flow) · [Python fallback](scripts/update_repo_stats.py).*
<!-- repo-stats:end -->
