...
|---|---:|---:|
| **Tracked source** | 1,868 | 169,242 |
| **Flow language** | 1,526 | 77,338 |
| **Python compiler (`src/flow`)** | 44 | 34,628 |
| **Self-hosted compiler (`compiler/src`)** | 17 | 8,592 |
| **Standard library modules** | 82 | 15,165 |
| **Native runtime** | 24 | 3,606 |
| **Examples (excluding verify corpus)** | 139 | 18,541 |
| **Verify corpus** | 1,078 | 18,715 |
| **Tests (`.py` + `.flow`)** | 201 | 20,398 |
| **Application programs** | 8 | 1,537 |
| **Registry packages** | 2 | — |
| **Documentation pages** | 82 | 17,739 |
...
*Generated by CI from tracked files at `3be6dd8fda4c`. Proof documents: 1,080. [Raw JSON](docs/generated/repository-stats.json) · [Flow counter](scripts/tools/repo_stats/main.flow) · [Python fallback](scripts/update_repo_stats.py).*
<!-- repo-stats:end -->
