...
|---|---:|---:|
| **Tracked source** | 3,356 | 474,714 |
| **Flow language** | 2,223 | 240,070 |
| **Python compiler (`src/flow`)** | 84 | 56,864 |
| **Self-hosted compiler (`compiler/src`)** | 77 | 30,034 |
| **Standard library modules** | 112 | 33,549 |
| **Native runtime** | 45 | 8,496 |
| **Examples (excluding verify corpus)** | 433 | 113,698 |
| **Verify corpus** | 1,078 | 18,715 |
| **Tests (`.py` + `.flow`)** | 564 | 58,753 |
| **Application programs** | 8 | 1,537 |
| **Registry packages** | 19 | — |
| **Documentation pages** | 194 | 40,427 |
...
*Generated by CI from tracked files at `64ed904217f7`. Proof documents: 1,080. [Raw JSON](docs/generated/repository-stats.json) · [Flow counter](scripts/tools/repo_stats/main.flow) · [Python fallback](scripts/update_repo_stats.py).*
<!-- repo-stats:end -->
