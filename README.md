...
|---|---:|---:|
| **Tracked source** | 3,087 | 439,111 |
| **Flow language** | 2,078 | 226,239 |
| **Python compiler (`src/flow`)** | 70 | 50,693 |
...
| **Tests (`.py` + `.flow`)** | 432 | 46,767 |
| **Application programs** | 8 | 1,537 |
| **Registry packages** | 19 | — |
| **Documentation pages** | 173 | 39,463 |
...
*Generated by CI from tracked files at `cc1f4d076199`. Proof documents: 1,080. [Raw JSON](docs/generated/repository-stats.json) · [Flow counter](scripts/tools/repo_stats/main.flow) · [Python fallback](scripts/update_repo_stats.py).*
<!-- repo-stats:end -->
