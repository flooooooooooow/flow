...
|---|---:|---:|
| **Tracked source** | 3,257 | 464,331 |
| **Flow language** | 2,170 | 236,487 |
| **Python compiler (`src/flow`)** | 81 | 55,540 |
| **Self-hosted compiler (`compiler/src`)** | 67 | 27,828 |
| **Standard library modules** | 111 | 33,245 |
| **Native runtime** | 45 | 8,352 |
| **Examples (excluding verify corpus)** | 430 | 113,664 |
| **Verify corpus** | 1,078 | 18,715 |
| **Tests (`.py` + `.flow`)** | 541 | 56,621 |
| **Application programs** | 8 | 1,537 |
| **Registry packages** | 19 | — |
| **Documentation pages** | 186 | 39,985 |
...
| HTML | 214 | 38,606 |
| C | 97 | 23,570 |
| C/C++ headers | 50 | 11,071 |
| C++ | 23 | 9,414 |
| JavaScript | 192 | 8,374 |
| Shell | 51 | 5,398 |
| CSS | 13 | 4,010 |
| Objective-C | 5 | 1,753 |
| Objective-C++ | 2 | 654 |
...
*Generated by CI from tracked files at `cb1b7f63ead4`. Proof documents: 1,080. [Raw JSON](docs/generated/repository-stats.json) · [Flow counter](scripts/tools/repo_stats/main.flow) · [Python fallback](scripts/update_repo_stats.py).*
<!-- repo-stats:end -->
