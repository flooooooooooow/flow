...
|---|---:|---:|
| **Tracked source** | 1,880 | 171,889 |
| **Flow language** | 1,532 | 78,239 |
| **Python compiler (`src/flow`)** | 45 | 35,216 |
| **Self-hosted compiler (`compiler/src`)** | 17 | 8,592 |
| **Standard library modules** | 82 | 15,165 |
| **Native runtime** | 24 | 3,606 |
| **Examples (excluding verify corpus)** | 144 | 18,745 |
| **Verify corpus** | 1,078 | 18,715 |
| **Tests (`.py` + `.flow`)** | 204 | 21,039 |
| **Application programs** | 8 | 1,537 |
| **Registry packages** | 2 | — |
| **Documentation pages** | 82 | 17,856 |
...
*Generated by CI from tracked files at `1b781319923a`. Proof documents: 1,080. [Raw JSON](docs/generated/repository-stats.json) · [Flow counter](scripts/tools/repo_stats/main.flow) · [Python fallback](scripts/update_repo_stats.py).*
<!-- repo-stats:end -->
