...
|---|---:|---:|
| **Tracked source** | 3,289 | 470,127 |
| **Flow language** | 2,189 | 239,009 |
| **Python compiler (`src/flow`)** | 82 | 56,077 |
| **Self-hosted compiler (`compiler/src`)** | 76 | 29,766 |
| **Standard library modules** | 111 | 33,268 |
| **Native runtime** | 45 | 8,496 |
| **Examples (excluding verify corpus)** | 431 | 113,674 |
| **Verify corpus** | 1,078 | 18,715 |
| **Tests (`.py` + `.flow`)** | 551 | 57,399 |
| **Application programs** | 8 | 1,537 |
| **Registry packages** | 19 | — |
| **Documentation pages** | 190 | 40,340 |
...
| HTML | 214 | 38,606 |
| C | 97 | 25,142 |
| C/C++ headers | 50 | 11,082 |
| C++ | 23 | 9,414 |
| JavaScript | 192 | 8,517 |
| Shell | 53 | 5,635 |
| CSS | 13 | 4,010 |
| Objective-C | 5 | 1,753 |
| Objective-C++ | 2 | 654 |
...
*Generated by CI from tracked files at `bf5efbf7e98c`. Proof documents: 1,080. [Raw JSON](docs/generated/repository-stats.json) · [Flow counter](scripts/tools/repo_stats/main.flow) · [Python fallback](scripts/update_repo_stats.py).*
<!-- repo-stats:end -->
