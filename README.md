...
|---|---:|---:|
| **Tracked source** | 3,362 | 475,722 |
| **Flow language** | 2,225 | 240,358 |
| **Python compiler (`src/flow`)** | 84 | 57,207 |
| **Self-hosted compiler (`compiler/src`)** | 78 | 30,284 |
...
| **Tests (`.py` + `.flow`)** | 566 | 58,873 |
| **Application programs** | 8 | 1,537 |
| **Registry packages** | 19 | — |
| **Documentation pages** | 197 | 40,891 |
...
*Generated by CI from tracked files at `4a84dab49882`. Proof documents: 1,080. [Raw JSON](docs/generated/repository-stats.json) · [Flow counter](scripts/tools/repo_stats/main.flow) · [Python fallback](scripts/update_repo_stats.py).*
<!-- repo-stats:end -->
