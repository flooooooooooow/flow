...
|---|---:|---:|
| **Tracked source** | 1,887 | 173,162 |
| **Flow language** | 1,535 | 78,415 |
| **Python compiler (`src/flow`)** | 46 | 35,913 |
...
| **Tests (`.py` + `.flow`)** | 207 | 21,439 |
| **Application programs** | 8 | 1,537 |
| **Registry packages** | 2 | — |
| **Documentation pages** | 82 | 17,877 |
...
*Generated by CI from tracked files at `a3d9762f5770`. Proof documents: 1,080. [Raw JSON](docs/generated/repository-stats.json) · [Flow counter](scripts/tools/repo_stats/main.flow) · [Python fallback](scripts/update_repo_stats.py).*
<!-- repo-stats:end -->
