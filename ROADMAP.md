...
| WASM target | ✅ Flow→C\|MLIR→emscripten, plus direct MLIR→LLVM→wasm32 with no Emscripten ([docs/language/wasm.md](docs/language/wasm.md), `#221`); native Flow-in-WASM deferred | Web deployment |
