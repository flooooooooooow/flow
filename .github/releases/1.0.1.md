...
Flow 1.0.1 is a stabilization patch over the Flow 1.0 compatibility contract. It does not promote, remove, or incompatibly change any Stable 1.x syntax or API, and the runtime ABI remains version 1.
