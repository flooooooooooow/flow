...
#define VK_INSTANCE_CREATE_ENUMERATE_PORTABILITY_BIT_KHR 0x00000001
    ...
    void createGraphicsPipeline() {
        auto vertShaderCode = readFile("demos/vulkan_triangle/shaders/triangle.vert.spv");
        auto fragShaderCode = readFile("demos/vulkan_triangle/shaders/triangle.frag.spv");
